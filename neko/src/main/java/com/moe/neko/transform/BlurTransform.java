...
public class BlurTransform implements Transform{
    private int level;
    //private Context c;
    public BlurTransform(int level){
        this.level=level;
        //this.c=c.getApplicationContext();
    }

    @Override
    public Bitmap transform(BitmapPool bp,Bitmap source, int w, int h)
    {
        Bitmap out_bitmap=bp.get(source.getWidth()/4,source.getHeight()/4,Bitmap.Config.ARGB_8888);
    ...
    public String getId()
    {
        return "blur:".concat(String.valueOf(level));
    }
